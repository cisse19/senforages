        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('gestionnaires.store')}}">
                    ...
                    <input type="hidden" name="gestionnaire" value="{{$gestionnaire->id ??''}}" class="form-control" name="inputName" id="inputName" placeholder="">
                    {{-- colonne matricule --}}
                    <div class="form-group">
                        <label for="input-matricule">Matricule</label>
                        <input type="text" name="matricule" class="form-control" id="input-matricule" aria-describedby="emailHelp" placeholder="Matricule du gestionnaire">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="prenom" class="form-control" id="input-prenom" aria-describedby="emailHelp" placeholder="Prenom du gestionnaire">
