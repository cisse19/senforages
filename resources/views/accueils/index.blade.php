...
<meta name="description" content="SenForage template project">
...
<div class="super_container">
			...
			<div class="row">
				<div class="col">
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						<div class="logo">
							<a href="#"><img src="{{asset('assets/images/senforage.jpg')}}" style="width:90px;border-radius:50%" alt=""></a>
						</div>
						<nav class="main_nav">
							<ul>
						...
						<div class="phone_num ml-auto">
							<div class="phone_num_inner">
								<img src="{{asset('assets/images/phone.png')}}" alt=""><span>652-345 3222 11</span>
							</div>
						</div>
			...
			<div class="logo menu_logo">
				<a href="#">
					<div class="logo_container d-flex flex-row align-items-start justify-content-start">
						<div class="logo_image"><div><img src="{{asset('assets/images/logo.png')}}" alt=""></div></div>
					</div>
				</a>
			</div>
			<ul>
									...
									<div class="slide_content">
										...
										<div class="home_details">
											<ul class="home_details_list d-flex flex-row align-items-center justify-content-start">
												<li>
													<div class="home_details_image"><img src="{{asset('assets/images/icon_1.png')}}" alt=""></div>
													<span> 650 Ftsq</span>
												</li>
												<li>
													<div class="home_details_image"><img src="{{asset('assets/images/icon_2.png')}}" alt=""></div>
													<span> 3 Bedrooms</span>
												</li>
												<li>
													<div class="home_details_image"><img src="{{asset('assets/images/icon_3.png')}}" alt=""></div>
						...
						<div class="owl-carousel owl-theme recent_slider">
								...
								<div class="recent_item">
									<div class="recent_item_inner">
										<div class="recent_item_image">
											<img src="{{asset('assets/images/property_1.jpg')}}" alt="">
										...
										<div class="recent_item_footer d-flex flex-row align-items-center justify-content-start">
											<div><div class="recent_icon"><img src="{{asset('assets/images/icon_1.png')}}" alt=""></div><span>650 Ftsq</span></div>
											<div><div class="recent_icon"><img src="{{asset('assets/images/icon_2.png')}}" alt=""></div><span>3 Bedrooms</span></div>
											<div><div class="recent_icon"><img src="{{asset('assets/images/icon_3.png')}}" alt=""></div><span>3 Bathrooms</span></div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="owl-item">
								<div class="recent_item">
									<div class="recent_item_inner">
										<div class="recent_item_image">
											<img src="{{asset('assets/images/property_2.jpg')}}" alt="">
							...
							<div class="owl-item">
								<div class="recent_item">
									<div class="recent_item_inner">
										<div class="recent_item_image">
											<img src="{{asset('assets/images/property_3.jpg')}}" alt="">
											<div class="tag_featured property_tag"><a href="#">Featured</a></div>
										</div>
										<div class="recent_item_body text-center">
	...
	<div class="cities">
		...
		<div class="cities_container d-flex flex-row flex-wrap align-items-start justify-content-between">
			...
			<!-- City -->
			<div class="city">
				<img src="{{asset('assets/images/city_1.jpg')}}" alt="https://unsplash.com/@dnevozhai">
			...
			<!-- City -->
			<div class="city">
				<img src="{{asset('assets/images/city_2.jpg')}}" alt="https://unsplash.com/@lachlanjdempsey">
				<div class="city_overlay">
					<a href="#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<!-- City -->
			<div class="city">
				<img src="{{asset('assets/images/city_3.jpg')}}" alt="https://unsplash.com/@hellolightbulb">
				<div class="city_overlay">
					<a href="#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<!-- City -->
			<div class="city">
				<img src="{{asset('assets/images/city_4.jpg')}}" alt="https://unsplash.com/@justinbissonbeck">
				<div class="city_overlay">
					<a href="#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<!-- City -->
			<div class="city">
				<img src="{{asset('assets/images/city_5.jpg')}}" alt="https://unsplash.com/@claudiotrigueros">
				<div class="city_overlay">
					<a href="#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<!-- City -->
			<div class="city">
				<img src="{{asset('assets/images/city_6.jpg')}}" alt="https://unsplash.com/@andersjilden">
				<div class="city_overlay">
					<a href="#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<!-- City -->
			<div class="city">
				<img src="{{asset('assets/images/city_7.jpg')}}" alt="https://unsplash.com/@sawyerbengtson">
				<div class="city_overlay">
					<a href="#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<!-- City -->
			<div class="city">
				<img src="{{asset('assets/images/city_8.jpg')}}" alt="https://unsplash.com/@mathewwaters">
				<div class="city_overlay">
					<a href="#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<div class="row testimonials_row">
				...
				<div class="col-lg-4 testimonial_col">
					<div class="testimonial">
						...
						<div class="testimonial_author_image"><img src="{{asset('assets/images/testimonial_1.jpg')}}" alt=""></div>
				...
				<div class="col-lg-4 testimonial_col">
					<div class="testimonial">
						...
						<div class="testimonial_author_image"><img src="{{asset('assets/images/testimonial_2.jpg')}}" alt=""></div>
				...
				<div class="col-lg-4 testimonial_col">
					<div class="testimonial">
						...
						<div class="testimonial_author_image"><img src="{{asset('assets/images/testimonial_3.jpg')}}" alt=""></div>
	...
	<footer class="footer">
		<div class="footer_main">
			<div class="container">
				<div class="row">
					<div class="col-lg-3">
						<div class="footer_logo"><a href="#"><img src="{{asset('assets/images/logo_large.png')}}" alt=""></a></div>
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-3 footer_col">
						<div class="footer_latest d-flex flex-row align-items-start justify-content-start">
							<div><div class="footer_latest_image"><img src="{{asset('assets/images/footer_latest_1.jpg')}}" alt=""></div></div>
					...
					<div class="col-lg-3 footer_col">
						<div class="footer_latest d-flex flex-row align-items-start justify-content-start">
							<div><div class="footer_latest_image"><img src="{{asset('assets/images/footer_latest_2.jpg')}}" alt=""></div></div>
							<div class="footer_latest_content">
								<div class="footer_latest_location">Miami</div>
					...
					<div class="col-lg-3 footer_col">
						<div class="footer_latest d-flex flex-row align-items-start justify-content-start">
							<div><div class="footer_latest_image"><img src="{{asset('assets/images/footer_latest_3.jpg')}}" alt=""></div></div>
							<div class="footer_latest_content">
								<div class="footer_latest_location">Miami</div>
...
<script src="{{asset('assets/plugins/parallax-js1-master/parallax.min.js')}}"></script>
